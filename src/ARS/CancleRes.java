...
import static ARS.ViewR.GetTable;
import java.sql.*;
 ...
 */
public class CancleRes extends javax.swing.JFrame {
    String fid,flfrom,flto,User,em;
    /**
     * Creates new form CancleRes
     */
    public CancleRes() {
        initComponents();
        String email = UserPanel.em;
        em = email;
        String sql = "SELECT * FROM `flightr` WHERE `User` LIKE '"+email+"'";
        GetTable(sql);
    }
    ...
    private void initComponents() {
        ...
        Viewt.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "User Name", "Flight ID", "From / Source", "To / Destination ", "Dep Time", "Cabin Class", "Flight Charge", "Booking Status", "ID"
            }
        ));
        ...
        jScrollPane1.setBounds(0, 180, 800, 320);
        ...
        jPanel1.add(txtfrom);
        txtfrom.setBounds(40, 130, 150, 40);
        ...
        jLabel4.setText("To :");
        jPanel1.add(jLabel4);
        jLabel4.setBounds(240, 110, 50, 16);
        ...
        jPanel1.add(txtto);
        txtto.setBounds(240, 130, 150, 40);

        jLabel5.setText("Booked by:");
        jPanel1.add(jLabel5);
        jLabel5.setBounds(420, 110, 140, 16);
        ...
        jPanel1.add(txtuser);
        txtuser.setBounds(420, 130, 160, 40);
        ...
        jButton1.setBounds(620, 130, 140, 40);
    ...
    private void ViewtMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_ViewtMouseClicked
        ...
        txtfrom.setText(flfrom);
        flto=dft.getValueAt(sindex,3).toString();
        txtto.setText(flto);
        User =dft.getValueAt(sindex,0).toString();
        txtuser.setText(User);
        fid=dft.getValueAt(sindex,8).toString();
    ...
    try{
        DB con =new DB();
        //String sql = "UPDATE `flightr` SET `status` = CASE WHEN `status` = 'Active' THEN 'Canceled' END WHERE `id` = '"+fid+"' COLLATE utf8mb4_bin";
        String sql = "UPDATE `flightr` SET `status` = CASE WHEN `status` = 'Active' THEN 'Canceled' ELSE `status` END WHERE `id` = '"+fid+"' COLLATE utf8mb4_bin";

        con.stm.executeUpdate(sql);
        JOptionPane.showMessageDialog(null,"Booking Canceled");
        String sql1 = "SELECT * FROM `flightr` WHERE `User` LIKE '"+em+"'";
        GetTable(sql1);
    }
    catch(Exception e){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CancleRes.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
